...
class UserProfile(models.Model):
    ...
    default_street_address1 = models.CharField(max_length=40, null=True, blank=True)
    default_street_address2 = models.CharField(max_length=40, null=True, blank=True)
